...
import (
	...
	"github.com/Alexander272/new-sealur-pro/internal/jacketed/transport/http/sizes"
...
func (h *Handler) Init(api *gin.RouterGroup, middleware *middleware.Middleware) {
	...
	jacketed_type.Register(jacketed, h.services.JacketedType, middleware)
	...
	sizes.Register(jacketed, h.services.Size, middleware)
}

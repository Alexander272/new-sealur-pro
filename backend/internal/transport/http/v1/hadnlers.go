...
import (
	...
	"github.com/Alexander272/new-sealur-pro/internal/transport/http/v1/companies"
	"github.com/Alexander272/new-sealur-pro/internal/transport/http/v1/feedback"
...
func Register(api *gin.RouterGroup, deps *Deps) {
	...
	users.Register(api, &users.Deps{Services: deps.Services, Conf: deps.Conf.Auth, Middleware: deps.Middleware})
	feedback.Register(api, deps.Services.Feedback, deps.Middleware)
	companies.Register(api, deps.Services.Company, deps.Middleware)

...
CREATE TABLE IF NOT EXISTS public.jacketed_flange_type
(
    id uuid NOT NULL,
...
ALTER TABLE IF EXISTS public.jacketed_flange_type
    OWNER to postgres;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS public.jacketed_flange_type;
-- +goose StatementEnd

...
CREATE TABLE IF NOT EXISTS public.position_snp_design
(
    id uuid NOT NULL,
    ...
    CONSTRAINT position_snp_design_pkey PRIMARY KEY (id),
    CONSTRAINT position_snp_design_position_id_fkey FOREIGN KEY (position_id)
...
ALTER TABLE IF EXISTS public.position_snp_design
    OWNER to postgres;
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS public.position_snp_design;
-- +goose StatementEnd

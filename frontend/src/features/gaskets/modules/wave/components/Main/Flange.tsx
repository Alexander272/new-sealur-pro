...
import { useGetWaveFlangeTypesQuery } from '../../waveApiSlice'
import { getFlangeType, getStandard, setMainFlangeType } from '../../waveSlice'
...
export const FlangeType = () => {
	...
	const { data, isFetching, isUninitialized } = useGetWaveFlangeTypesQuery(standard?.id || '', { skip: !standard })

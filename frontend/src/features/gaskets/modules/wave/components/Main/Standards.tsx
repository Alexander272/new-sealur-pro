...
import type { IWaveStandard } from '../../types/main'
...
export const Standards = () => {
	...
	const { data, isFetching } = useGetWaveStandardQuery(null)
	...
	const changeHandler = useCallback((value: IWaveStandard) => dispatch(setMainStandard(value)), [dispatch])

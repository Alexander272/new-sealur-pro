...
import type { IPlating } from '../../types/material'
...
export const Plating = () => {
	...
	const { data, isFetching } = useGetWavePlatingQuery(standard?.id || '', { skip: !standard })
	...
	const changeHandler = useCallback((value: IPlating) => dispatch(setPlating(value)), [dispatch])

	return (
		<BaseFiller
			data={data?.data || []}
			isFetching={isFetching}
			title='Материал плакировки'
			value={plating?.id}

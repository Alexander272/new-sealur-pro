...
import { getDesignErrors, getStandard } from '../../waveSlice'
import { useGetWaveInfoQuery } from '../../waveApiSlice'
...
export const Design = () => {
	...
	const { data } = useGetWaveInfoQuery(standard?.id || '', { skip: !standard?.id })
